...
<?php
global $the_query, $load_posts, $wp_the_query, $load_card_type, $additional_filter,  $label, $label_no_more, $classes, $wrap_card;
...
$wrap_card_param = $wrap_card ? '1' : '0';
$query_params = '?post_count='.$the_query->post_count.'&load_posts='.$load_posts.'&search='.$query_search.'&post_types='.$post_types.'&load_card_type='.$load_card_type.'&wrap_card='.$wrap_card_param.'&query_params='.$query_params.'&additional_filter='.$additional_filter;
