        ...
        <div class="container">
            <div class="row">
              <div class="col-12 footer-items-wrapper logo-wrapper">
                <div class="it-brand-wrapper">
                  <a target="_blank" href="https://www.comune.napoli.it/">
                    <img class="logo-comune icon" src="https://static-www.comune.napoli.it/wp-content/uploads/2024/03/Logo-Napoli.png" alt="logo Comune di Napoli">
                  </a>
                </div>
                <div class="it-brand-wrapper">
            ...
            <div class="row">
              <div class="col-12 text-uppercase">
                PORTALE TEMATICO DELL’AREA CULTURA DEL COMUNE DI NAPOLI
              </div>
            </div>
            <div class="row">
              ...
              <div class="col-md-3 footer-items-wrapper">
                ...
                <div class="col-md-9 mt-md-4 footer-items-wrapper">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <strong>Comune di Napoli - Area Cultura</strong><br>
                        Palazzo Cavalcanti<br>
                        Via Toledo 348 - 80134 Napoli
                      </div>
                      <div class="col-md-6">
                        <strong>Telefono:</strong> 0039 081 7955237<br>
                        <strong>E-mail:</strong> <a target="_blank" href="mailto:area.cultura.turismo@comune.napoli.it">area.cultura.turismo@comune.napoli.it</a><br>
                        Vai alla pagina dedicata su <a target="_blank" href="https://comune.napoli.it">comune.napoli.it</a>
                      </div>
                      <?php /*
                        <div class="col-md-4">
                            <p class="footer-info">
                ...
                <div class="col-md-3 mt-md-4 footer-items-wrapper">
                    ...
                    <?php } ?>
                    <p>
                        <a href="https://cultura.comune.napoli.it/newsletter/">Iscriviti alla newsletter</a><br>
                        <a href="https://cultura.comune.napoli.it/press-kit/">Consulta l'Area stampa</a><br>
                        <a href="https://cultura.comune.napoli.it/tipi_notizia/bandi-e-avvisi-pubblici/">Consulta l'Area bandi</a>
                    </p>
                </div>
            </div>
            <div class="row">
                <div class="col-12 footer-items-wrapper">
                    <div class="footer-bottom">
                        © 2026 Comune di Napoli | Sito realizzato utilizzando il <a target="_blank" href="https://designers.italia.it/modelli/comuni/">Modello Comuni di Designers Italia</a>
